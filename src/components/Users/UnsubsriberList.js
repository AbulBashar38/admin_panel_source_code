...
const UnsubscriberList = () => {
    ...
    useEffect(() => {
        async function list() {
            await axios.get(`${process.env.REACT_APP_API_URL}unsubscribe-users`)
                .then((resp) => {
                    console.log(resp)
                    setUnsubscribe(resp.data.users)
                })
                .catch((err) => {
                    console.error(err);
                });
            ...
            >
                <div className="row clearfix">
                    <div className="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                        <h1 style={{ fontSize: "30px" }}>Unsubscribed Users</h1>
                    </div>
                </div>
            </div>
            <div>
...
export default UnsubscriberList;
