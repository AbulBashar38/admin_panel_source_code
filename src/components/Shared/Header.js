                ...
                <div className="container-fluid">
                    <div className="navbar-left">
                        <div className="navbar-btn">
                            {/* <Link to="/dashboard"><img src="../assets/images/icon.svg" alt="Oculux Logo" className="img-fluid logo" /></Link> */}
                        ...
                        {/* <ul className="nav navbar-nav">
                            <li className="dropdown">
                                <span className="dropdown-toggle icon-menu" data-toggle="dropdown">
                                    ...
                                    <span className="notification-dot bg-green">6</span>
                                </span>
                    ...
                    <div className="navbar-right">
                        <div id="navbar-menu">
                            <ul className="nav navbar-nav">
                                ...
                                <li><Link to="/login" onClick={signoutHendler} className="icon-menu"><i className="icon-power"></i></Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
